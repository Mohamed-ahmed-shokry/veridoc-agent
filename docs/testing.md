...
Veridoc uses pytest. The Phase 5 suite covers the FastAPI application, bounded
...
Run focused Phase 2, Phase 3, Phase 4, and Phase 5 modules:
...
No static type checker or coverage threshold is configured in Phase 5. Do not
