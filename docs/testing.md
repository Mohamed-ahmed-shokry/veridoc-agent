...
Veridoc uses pytest. The Phase 4 suite covers the FastAPI application, bounded
...
explanation providers, and the typed explanation graph.
...
Run focused Phase 2, Phase 3, and Phase 4 modules:
...
No static type checker or coverage threshold is configured in Phase 4. Do not
